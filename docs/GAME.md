...
- 같은 난이도에서 격파한 상대는 전투 버튼 옆의 소탕으로 1~100회 반복 승리 뽑기권을 즉시 받을 수 있습니다.
- 1회 비용: 일반 임신의 증거 1개, 하드 4개, 카오스 10개. 익스트림은 파편 2개 또는 임신의 증거 30개를 선택합니다.
- 익스트림은 받을 뽑기권 종류도 선택합니다. 소탕에는 첫 격파·업적·파편 보상이 없고 전투 전적에 합산되지 않습니다.
- 비용과 총 보상을 확인한 뒤 실행합니다. 재료 차감과 지급은 함께 저장되며 같은 요청을 다시 확인해도 중복 지급되지 않습니다. 계정 초기화 시 소탕 처리 기록도 다른 게임 기록과 함께 삭제됩니다.
- 신규 계정은 하급 뽑기권 3장으로 시작합니다. 기존 매일 무료 카드 1장은 유지됩니다.
